...
public class AdvChoicePatch
{
    ...
    [HarmonyPostfix]
    public static void AdvChoiceConstructorPostfix(AdvChoice __instance, GameObject ___grp)
    {
        for (var i = 0; i < ___grp.transform.childCount; i++)
        {
            var child = ___grp.transform.GetChild(i);
